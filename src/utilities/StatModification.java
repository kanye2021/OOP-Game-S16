...
public class StatModification {
	...
	public static enum NumberType {
		...
		POINT {protected int getModifierAmount(int initialStatNumber, int delta, Direction direction) {return delta;};},
		PERCENTAGE {protected int getModifierAmount(int initialStatNumber, int delta, Direction direction) {
